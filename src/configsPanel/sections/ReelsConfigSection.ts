...
export class ReelsConfigSection implements IConfigSection {
    ...
    public createController(): GUI {
        ...
        folder
            ...
            .name("Min spin duration, [sec]");
        folder
            .add(ReelsConstants, "PER_REEL_STOPPING_DELAY", 0, 2000, 1)
            .name("Per reel stopping delay, [sec]");
